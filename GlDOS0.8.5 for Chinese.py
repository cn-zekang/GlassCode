...
ad = 'admin'
if output == ad:
    print("欢迎来到", 'Glass', 'DOS', '系统', ' 0.8.5')  # 欢迎进入 GLASS DOS 操作系统(玻璃磁盘操作系统)
    dir = 'dir'  # 定义命令
